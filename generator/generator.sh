...
curl "https://api.dashboard.eco/co2-daily" >> ${JSFILE}
echo ";" >> ${JSFILE}
echo -n "redisCO2Daily" 
wc ${JSFILE}

echo "let redisCO2Now=" >> ${JSFILE}
curl "https://api.dashboard.eco/maunaloaco2-daily" >> ${JSFILE}
echo ";" >> ${JSFILE}
echo -n "redisCO2Now" 
wc ${JSFILE}

echo "let redisCovidDeathsSelect=" >> ${JSFILE}
curl "https://api.dashboard.eco/covid-deaths-select" >> ${JSFILE}
echo ";" >> ${JSFILE}
echo -n "redisCovidDeathsSelect" 
wc ${JSFILE}

echo "let redisCovidDeathsTop=" >> ${JSFILE}
curl "https://api.dashboard.eco/covid-deaths-top" >> ${JSFILE}
echo ";" >> ${JSFILE}
echo -n "redisCovidDeathsTop" 
wc ${JSFILE}

echo "let redisMaunaLoaCO2Sm=" >> ${JSFILE}
curl "http://api.dashboard.eco/maunaloaco2-sm" >> ${JSFILE}
echo ";" >> ${JSFILE}
echo -n "redisMaunaLoaCO2Sm" 
wc ${JSFILE}

echo "let redisMaunaLoaAnnualMean=" >> ${JSFILE}
curl "http://api.dashboard.eco/maunaloa-annual-mean" >> ${JSFILE}
echo ";" >> ${JSFILE}
echo -n "redisMaunaLoaAnnualMean" 
wc ${JSFILE}

echo "let redisLaw2018CO2=" >> ${JSFILE}
curl "http://api.dashboard.eco/law2018co2" >> ${JSFILE}
echo ";" >> ${JSFILE}
echo -n "redisLaw2018CO2" 
wc ${JSFILE}

echo "let redisVostok=" >> ${JSFILE}
curl "http://api.dashboard.eco/vostok" >> ${JSFILE}
echo ";" >> ${JSFILE}
echo -n "redisVostok" 
wc ${JSFILE}

echo "let redisMaunaLoaCH4Sm=" >> ${JSFILE}
curl "http://api.dashboard.eco/maunaloach4-sm" >> ${JSFILE}
echo ";" >> ${JSFILE}
...
do
  curl "http://api.dashboard.eco/spain-electricity-${YEAR}" >> ${JSFILE}
  echo "," >> ${JSFILE}
done
echo "];" >> ${JSFILE}
...
do
  curl "http://api.dashboard.eco/glacier-length-nor-${GLACIER}" >> ${JSFILE}
  echo "," >> ${JSFILE}
done
echo "];" >> ${JSFILE}
...
#do
#  curl "http://api.dashboard.eco/norway-traffic-${STATION}" >> ${JSFILE}
#  echo "," >> ${JSFILE}
#done
#echo "];" >> ${JSFILE}
...
#for YEAR in '2020'
#do
#  curl "http://api.dashboard.eco/schiphol-flights-${YEAR}" >> ${JSFILE}
#  echo "," >> ${JSFILE}
#done
#echo "];" >> ${JSFILE}
...
curl "http://api.dashboard.eco/covid-deaths-regions" >> ${JSFILE}
echo ";" >> ${JSFILE}
echo -n "redisCovidDeathsRegions" 
wc ${JSFILE}

echo "let redisIrena2020 =" >> ${JSFILE}
curl "http://api.dashboard.eco/irena-2020" >> ${JSFILE}
echo ";" >> ${JSFILE}
