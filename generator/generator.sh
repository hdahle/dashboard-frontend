...
curl ${CURLFLAG} "https://api.dashboard.eco/co2-daily" >> ${JSFILE}
echo ";" >> ${JSFILE}
echo -n "redisCO2Daily" 
wc ${JSFILE}

echo "let redisCO2Now=" >> ${JSFILE}
curl ${CURLFLAG} "https://api.dashboard.eco/maunaloaco2-daily" >> ${JSFILE}
echo ";" >> ${JSFILE}
echo -n "redisCO2Now" 
wc ${JSFILE}

echo "let redisCovidDeathsSelect=" >> ${JSFILE}
curl ${CURLFLAG} "https://api.dashboard.eco/covid-deaths-select" >> ${JSFILE}
echo ";" >> ${JSFILE}
echo -n "redisCovidDeathsSelect" 
wc ${JSFILE}

echo "let redisCovidDeathsTop=" >> ${JSFILE}
curl ${CURLFLAG} "https://api.dashboard.eco/covid-deaths-top" >> ${JSFILE}
echo ";" >> ${JSFILE}
echo -n "redisCovidDeathsTop" 
wc ${JSFILE}

echo "let redisMaunaLoaCO2Sm=" >> ${JSFILE}
curl ${CURLFLAG} "http://api.dashboard.eco/maunaloaco2-sm" >> ${JSFILE}
echo ";" >> ${JSFILE}
echo -n "redisMaunaLoaCO2Sm" 
wc ${JSFILE}

echo "let redisMaunaLoaAnnualMean=" >> ${JSFILE}
curl ${CURLFLAG} "http://api.dashboard.eco/maunaloa-annual-mean" >> ${JSFILE}
echo ";" >> ${JSFILE}
echo -n "redisMaunaLoaAnnualMean" 
wc ${JSFILE}

echo "let redisLaw2018CO2=" >> ${JSFILE}
curl ${CURLFLAG} "http://api.dashboard.eco/law2018co2" >> ${JSFILE}
echo ";" >> ${JSFILE}
echo -n "redisLaw2018CO2" 
wc ${JSFILE}

echo "let redisVostok=" >> ${JSFILE}
curl ${CURLFLAG} "http://api.dashboard.eco/vostok" >> ${JSFILE}
echo ";" >> ${JSFILE}
echo -n "redisVostok" 
wc ${JSFILE}

echo "let redisMaunaLoaCH4Sm=" >> ${JSFILE}
curl ${CURLFLAG} "http://api.dashboard.eco/maunaloach4-sm" >> ${JSFILE}
echo ";" >> ${JSFILE}
...
do
  curl ${CURLFLAG} "http://api.dashboard.eco/spain-electricity-${YEAR}" >> ${JSFILE}
  echo "," >> ${JSFILE}
done
echo "];" >> ${JSFILE}
...
do
  curl ${CURLFLAG} "http://api.dashboard.eco/glacier-length-nor-${GLACIER}" >> ${JSFILE}
  echo "," >> ${JSFILE}
done
echo "];" >> ${JSFILE}
...
#do
#  curl ${CURLFLAG} "http://api.dashboard.eco/norway-traffic-${STATION}" >> ${JSFILE}
#  echo "," >> ${JSFILE}
#done
#echo "];" >> ${JSFILE}
...
#for YEAR in '2020'
#do
#  curl ${CURLFLAG} "http://api.dashboard.eco/schiphol-flights-${YEAR}" >> ${JSFILE}
#  echo "," >> ${JSFILE}
#done
#echo "];" >> ${JSFILE}
...
curl ${CURLFLAG} "http://api.dashboard.eco/covid-deaths-regions" >> ${JSFILE}
echo ";" >> ${JSFILE}
echo -n "redisCovidDeathsRegions" 
wc ${JSFILE}

echo "let redisIrena2020 =" >> ${JSFILE}
curl ${CURLFLAG} "http://api.dashboard.eco/irena-2020" >> ${JSFILE}
echo ";" >> ${JSFILE}
...
curl ${CURLFLAG} "http://api.dashboard.eco/eia-lcoe-2025" >> ${JSFILE}
echo ";" >> ${JSFILE}
echo -n "redisEiaLcoe" 
wc ${JSFILE}

echo "let redisWri2016 =" >> ${JSFILE}
curl ${CURLFLAG} "http://api.dashboard.eco/wri-2016" >> ${JSFILE}
echo ";" >> ${JSFILE}
echo -n "redisWri2016" 
wc ${JSFILE}

echo "let redisOxfam2020 =" >> ${JSFILE}
curl ${CURLFLAG} "http://api.dashboard.eco/oxfam-2020" >> ${JSFILE}
echo ";" >> ${JSFILE}
echo -n "redisOxfam2020" 
wc ${JSFILE}

echo "let redisGlobalEwaste =" >> ${JSFILE}
curl ${CURLFLAG} "http://api.dashboard.eco/globalewaste-2020" >> ${JSFILE}
echo ";" >> ${JSFILE}
echo -n "redisGlobalEwaste" 
wc ${JSFILE}

echo "let redisPlasticWaste =" >> ${JSFILE}
curl ${CURLFLAG} "http://api.dashboard.eco/plastic-waste-2016" >> ${JSFILE}
echo ";" >> ${JSFILE}
echo -n "redisPlasticWaste" 
wc ${JSFILE}

echo "let redisBitcoinPower =" >> ${JSFILE}
curl ${CURLFLAG} "http://api.dashboard.eco/bitcoin-power" >> ${JSFILE}
echo ";" >> ${JSFILE}
echo -n "redisBitcoinPower" 
wc ${JSFILE}

echo "let redisBitcoinPrice =" >> ${JSFILE}
curl ${CURLFLAG} "http://api.dashboard.eco/bitcoin-price" >> ${JSFILE}
echo ";" >> ${JSFILE}
echo -n "redisBitcoinPrice" 
wc ${JSFILE}

echo "let redisPolestar =" >> ${JSFILE}
curl ${CURLFLAG} "http://api.dashboard.eco/polestar" >> ${JSFILE}
echo ";" >> ${JSFILE}
echo -n "redisPolestar" 
wc ${JSFILE}

echo "let redisEindhoven =" >> ${JSFILE}
curl ${CURLFLAG} "http://api.dashboard.eco/eindhoven" >> ${JSFILE}
echo ";" >> ${JSFILE}
echo -n "redisEindhoven" 
wc ${JSFILE}

echo "let redisEuAntibioticsDetails2018 =" >> ${JSFILE}
curl ${CURLFLAG} "http://api.dashboard.eco/eu-antibiotics-details-2018" >> ${JSFILE}
echo ";" >> ${JSFILE}
echo -n "redisEuAntibioticsDetails2018" 
wc ${JSFILE}

echo "let redisOecdMeat2020 =" >> ${JSFILE}
curl ${CURLFLAG} "http://api.dashboard.eco/oecd-meat-2020" >> ${JSFILE}
echo ";" >> ${JSFILE}
echo -n "redisOecdMeat2020" 
wc ${JSFILE}

echo "let redisOecdMeatSorted2019 =" >> ${JSFILE}
curl ${CURLFLAG} "http://api.dashboard.eco/oecd-meat-sorted-2019" >> ${JSFILE}
echo ";" >> ${JSFILE}
echo -n "redisOecdMeatSorted2019" 
wc ${JSFILE}

echo "let redisPooreNemecek2018 =" >> ${JSFILE}
curl ${CURLFLAG} "http://api.dashboard.eco/poore-nemecek-2018" >> ${JSFILE}
echo ";" >> ${JSFILE}
echo -n "redisPooreNemecek2018" 
wc ${JSFILE}

echo "let redisCovidDeathsSummary =" > ${JSFILE2}
curl ${CURLFLAG} "http://api.dashboard.eco/covid-deaths-summary" >> ${JSFILE2}
echo ";" >> ${JSFILE2}
echo -n "redisCovidDeathsSummary" 
wc ${JSFILE2}

echo "let redisCovidConfirmedSummary =" >> ${JSFILE2}
curl ${CURLFLAG} "http://api.dashboard.eco/covid-confirmed-summary" >> ${JSFILE2}
echo ";" >> ${JSFILE2}
