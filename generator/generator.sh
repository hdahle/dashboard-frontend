...
curl -s "http://api.dashboard.eco/eu-antibiotics-details-2018" >> ${JSFILE}
echo ";" >> ${JSFILE}
echo -n "redisEuAntibioticsDetails2018" 
wc ${JSFILE}

echo "let redisOecdMeat2020 =" >> ${JSFILE}
curl -s "http://api.dashboard.eco/oecd-meat-2020" >> ${JSFILE}
echo ";" >> ${JSFILE}
...
curl -s "http://api.dashboard.eco/poore-nemecek-2018" >> ${JSFILE}
echo ";" >> ${JSFILE}
